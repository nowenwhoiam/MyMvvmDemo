...
import com.example.yunmei.R;
import com.example.yunmei.databinding.FragmentYunmeiBinding;
...
public class HeadlineNewsFragment extends Fragment {
    ...
    FragmentYunmeiBinding viewDataBinding;
    HeadlineNewsViewModel viewModel = new HeadlineNewsViewModel();
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        viewDataBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_yunmei, container, false);
