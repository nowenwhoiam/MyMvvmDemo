...
import com.example.home.api.HomeApiInterface;
 ...
 */
public class HomeModel extends MvvmBaseModel<BaseResponse, ArrayList<BaseCustomViewModel>> {
    public HomeModel() {
        super(BaseResponse.class, true, "pref_key_home", null, 1);
    }
